...
export const journeys: ProductJourney[] = [
  ...
  },
  {
    ...
    updatedDate: "27 Aug 2026",
    note: "Fee overrides and wording changed after verification; Joey needs to re-check the latest UI.",
    screens: [
      screen("Approvals queue", "Prioritize submitted events", "admin-9-·-moderate-events--approvals-queue", "/organizer/admin"),
  ...
  },
  {
    ...
    verifiedDate: "15 Jul 2026",
    updatedDate: "27 Aug 2026",
    note: "Calculations and transfer confirmation work; the UI still awaits sign-off.",
    screens: [
      screen("Payout queue", "Review held, payable and paid payouts", "admin-10-·-platform-finance--financials", "/organizer/admin"),
    ],
  },
  {
    id: 11,
    ...
    verifiedDate: "14 Jul 2026",
    updatedDate: "27 Aug 2026",
    note: "Account tiers were removed; service fee and commission brackets now need a fresh UX check.",
    screens: [
      screen("Platform overview", "Monitor platform-level activity", "admin-11-·-platform-administration--overview", "/organizer/admin"),
      screen("User management", "Review organizer accounts", "admin-11-·-platform-administration--user-management", "/organizer/admin"),
      screen("Platform settings", "Edit service fee and commission brackets", "admin-11-·-platform-administration--settings", "/organizer/admin"),
    ],
  },
];
